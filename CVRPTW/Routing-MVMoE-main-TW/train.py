...
if __name__ == "__main__":
    ...
    # env_params
    parser.add_argument('--problem', type=str, default="VRPTW", choices=["VRPTW"])
    ...
    # model_params
    parser.add_argument('--model_type', type=str, default="SINGLE", choices=["SINGLE"])
    ...
    parser.add_argument('--milestones', type=int, nargs='+', default=[901, ], help='when to decay lr')
