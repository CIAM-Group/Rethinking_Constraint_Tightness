...
if __name__ == "__main__":
    ...
    # env_params
    parser.add_argument('--problem', type=str, default="VRPTW", choices=["ALL", "CVRP", "OVRP", "VRPB", "VRPL", "VRPTW", "OVRPTW",
    ...
    # model_params
    parser.add_argument('--model_type', type=str, default="SINGLE", choices=["SINGLE", "MTL", "MOE", "MOE_LIGHT"])
    ...
    # tester_params
    parser.add_argument('--checkpoint', type=str, default="./results/20250121_212206/epoch-1000.pt", help="load pretrained model to evaluate")
    ...
    parser.add_argument('--test_set_path', type=str, default='./data/VRPTW/vrptw100_uniform_0.2_n10000_speed_1.0_scale_10.0.pkl', help="evaluate on default test dataset if None")
    parser.add_argument('--test_set_opt_sol_path', type=str, default='./data/VRPTW/hgs_vrptw100_uniform_0.2_n10000_speed_1.0_scale_10.0.pkl', help="evaluate on default test dataset if None")
