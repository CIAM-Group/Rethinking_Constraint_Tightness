...
def get_env(problem):
    ...
    from envs import CVRPEnv, VRPTWEnv

    # training_problems = ['CVRP', 'OVRP', 'VRPB', 'VRPL', 'VRPTW', 'OVRPTW']
    training_problems = ['CVRP', 'VRPTW']
    all_problems = {
        'CVRP': CVRPEnv,
        # 'OVRP': OVRPEnv,
        # 'VRPB': VRPBEnv,
...
def get_opt_sol_path(dir, problem, size):
    all_opt_sol = {
        'VRPTW': {50: 'hgs_vrptw50_uniform.pkl', 100: 'hgs_vrptw100_uniform_0.2_n1000_speed_1.0_scale_1.0.pkl'},
    }
